...
/**
 * A {@code ZoomView} can display various graphical objects on the screen with zooming and panning capabilities.
 * 
 * @author Jeong-Hyon Hwang (jhh@cs.albany.edu)
 */
public abstract class ZoomView extends JPanel {
