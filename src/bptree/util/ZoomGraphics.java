...
/**
 * The {@code ZoomGraphics} class implements {@code java.awt.Graphics} equivalents with zooming capabilities.
 * 
...
public class ZoomGraphics {
	...
	/**
	 * The width of the {@code Graphics} context.
	 */
	protected int graphicsWidth = 0;

	/**
	 * The height of the {@code Graphics} context.
	 */
	protected int graphicsHeight = 0;

	/**
	 * The scale for the mapping from the virtual screen to the {@code Graphics} context.
	 */
	protected double scale = 1;

	/**
	 * The {@code Graphics} context.
	 */
	...
	/**
	 * Constructs a {@code ZoomGraphics}.
	 */
	public ZoomGraphics() {
	}
	...
	/**
	 * Sets this {@code ZoomGraphics} context.
	 * 
	 * @param g
	 *            the {@code Graphics} context
	 * @param graphicsWidth
	...
	/**
	 * Fills this {@code ZoomGraphics} context.
	 */
	public void fill() {
		if (g != null) {
	...
	/**
	 * Sets this {@code ZoomGraphics}' current color.
	 * 
	 * @param c
	 *            the color
	 */
	...
	/**
	 * Draws the text given by the specified string,s using this {@code ZoomGraphics}' current font and color.
	 * 
	 * @param s
	 *            the text string
	 * @param x
	...
	/**
	 * Draws the text given by the specified strings, using this {@code ZoomGraphics}' current font and color.
	 * 
	 * @param s
	 *            the text string
	 * @param x
	...
	/**
	 * Returns the current scale for the mapping from the virtual screen to the {@code Graphics} context
	 * 
	 * @return the current scale for the mapping from the virtual screen to the {@code Graphics} context
	 */
	...
	/**
	 * Moves this {@code ZoomGraphics} by the specified amount.
	 * 
	 * @param deltaX
	...
	/**
	 * Returns the corresponding x-position on the {@code Graphics} context for the specified x-position on the virtual
	 * screen.
	 * 
	 * @param x
	 *            the x-position on the virtual screen
	 * @return the corresponding x-position on the {@code Graphics} context for the specified x-position on the virtual
	 *         screen
	 */
	...
	/**
	 * Returns the corresponding y-position on the {@code Graphics} context for the specified y-position on the virtual
	 * screen.
	 * 
	 * @param y
	 *            the y-position on the virtual screen
	 * @return the corresponding y-position on the {@code Graphics} context for the specified y-position on the virtual
	 *         screen
	 */
